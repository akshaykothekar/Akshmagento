...
namespace Akshmagento\AkshProgressiveApp\Observer;
...
class UpdateManifest implements ObserverInterface
{
    ...
    {
        if ($this->_pwaHelper->isEnabled() && $this->_pwaHelper->isModuleOutputEnabled('Akshmagento_AkshProgressiveApp') == '1') {
            $manifestData = [
    ...
    public function updateManifestStatic($manifestData)
    {
        ...
        $staticPath = $this->directoryList->getPath(DirectoryList::STATIC_VIEW) .
            ...
            \DIRECTORY_SEPARATOR .
            'Akshmagento_AkshProgressiveApp' . \DIRECTORY_SEPARATOR . 'js' . \DIRECTORY_SEPARATOR;
    ...
    public function updateManifestApp($manifestData)
    {
        ...
        $appPath = $this->directoryList->getPath(DirectoryList::APP) .
            ...
            \DIRECTORY_SEPARATOR . 'Akshmagento' .
            \DIRECTORY_SEPARATOR . 'AkshProgressiveApp' .
    ...
    public function copyServiceWorkerJs()
    {
        ...
        if ($this->_pwaHelper->isEnabled() && $this->_pwaHelper->isModuleOutputEnabled('Akshmagento_AkshProgressiveApp') == '1') {
            $data = "/**
 * Copyright (c) 2020 Akshmagento (http://www.Akshmagento.com)
 */
...
var CACHE_NAME = 'pwa-osc-cache-v1';
